# MOTION PHILOSOPHY — Motion Discipline Reference

> **BRAND OVERRIDE (read first):** This doc is the motion *discipline* reference —
> pacing, structure, transitions, the laws. For your videos, the brand visual
> layer comes from `DESIGN.md`, not from here. In particular, headlines use
> **your headline treatment (define it in your brand tokens / design system)**, NOT the
> chrome/silver gradient (`#fff→#999→#ccc`) described below. Wherever this doc specifies
> a chrome fill, palette, or texture, substitute the values defined in your brand tokens.
> Keep everything else.

> Reference deconstruction of the **Infinite — Global Payments** 30s spot
> (`x-XTeSJ-DKx63uB4.mp4`, 1920×1080, 30fps, 900 frames). Use it for motion
> discipline (timing, transitions, structure). Re-read before starting any
> new composition.
